...
## The Logistic Map
The logistic map is a function which models population over time. It was developed by Robert May, and is a discrete-time, unit-free version of Verhulst's "Logistic Equation". The logistic map is often-studied example of how deterministic, non-linear functions can generate chaotic and complex behavior.  
